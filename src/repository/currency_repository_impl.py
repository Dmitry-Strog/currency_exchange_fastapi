...
class CurrencyRepositoryImpl(CurrencyRepository):
    ...
    async def find_all(self) -> Sequence[CurrencyModel]:
        try:
    ...
    async def find_one_or_none(self, filters: BaseModel) -> CurrencyModel | None:
    ...
    async def update(self, filters: BaseModel):
        pass
